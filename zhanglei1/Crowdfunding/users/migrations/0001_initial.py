    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('fale', '女')], default='fale', max_length=10)),
                ('address', models.CharField(max_length=100, verbose_name='地址')),
                ('mobbie', models.CharField(blank=True, max_length=11, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='type/default.png', upload_to='type/%Y/%m')),
